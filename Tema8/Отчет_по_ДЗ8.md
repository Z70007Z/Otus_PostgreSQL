...
```
![Статус кластера](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/cluster_info.jpg "Статус кластера")
...
```
![transactionid](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/transactionid.jpg "transactionid")
```bash
...
```
![info_mini](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/info_mini.jpg "info_mini")
```bash
...
# Картинка с выполненными командами ранее о статусе кластера (Картинка ниже!):
```
![session3](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/session3.jpg "session3")
```bash
...
```
![id транзакции](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/id_tr_block.jpg "id транзакции")
```bash
...
```
![id](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/id_3.jpg "id")
```bash
...
```
![number_base](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/number_base.jpg "number_base")
```bash
...
```
![what_Block](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/what_Block.jpg "what_Block")
```bash
# Для 4122 блокирующий pid 4055, а для 4055 блокирующий 4400.
# 4400 нужно на найти и удалить.! 
```
### 4400 далее будет 4740 (т.к. экспериментируя сбросил первую транзакцию. И txid_current() = 773) - номер блокирующий транзакции!!!  ###

```bash
# Выполнив команду 
    SELECT * FROM pg_stat_activity e WHERE pid = 4740;
```
![backend_id](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/backend_id.jpg "backend_id")
```bash
...
```
![From_dbiver](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema6/picture/From_dbiver.jpg "From_dbiver")
```bash
