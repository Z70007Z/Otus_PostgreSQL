...
# Практика №9 "Выборка данных, виды join'ов. Применение и оптимизация."
...
```
![Статус кластера](https://github.com/Z70007Z/Otus_PostgreSQL/blob/main/Tema9/picture/status_cluster.jpg "Статус кластера")
