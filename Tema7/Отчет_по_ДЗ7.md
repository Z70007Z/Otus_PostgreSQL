...
Берем первый результат получаенный за время теста pgbench: 
Вышло 433735048 байт.
Время 10 минут. (600 секунд)
Сheckpoint каздый 30 секунд.
600/30=20;
и 433735048/20 = 21686752 байт.
или по 21 мб примерно приходится на одну точку под нагрузкрой.

Я думаю что так не совсем верно сичитать, прошу подсказать, и я обязательно проверю на практике. !!!
#
...
Судя по tps синхронного режима и аминхронного, ничего не изменилось у меня.
...
# Включаем контрольные суммой страниц:
  ...
  # она же не рабоатет или я что-то не понял? (
